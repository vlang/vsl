// Copyright (c) 2019 Ulises Jeremias Cornejo _fandos. All rights reserved.
...
fn test_diff() {
        _f1 := vsl.Function{function: f1}
        _df1 := vsl.Function{function: df1}

        _f2 := vsl.Function{function: f2}
        _df2 := vsl.Function{function: df2}

        _f3 := vsl.Function{function: f3}
        _df3 := vsl.Function{function: df3}

        _f4 := vsl.Function{function: f4}
        _df4 := vsl.Function{function: df4}

        _f5 := vsl.Function{function: f5}
        _df5 := vsl.Function{function: df5}

        _f6 := vsl.Function{function: f6}
        _df6 := vsl.Function{function: df6}
        ...
        assert diff_test('central', _f5, _df5, f64(0.0))
        assert diff_test('forward', _f5, _df5, f64(0.0))
        assert diff_test('backward', _f5, _df5, f64(0.0))
