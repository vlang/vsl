	...
	if uplo == .upper {
		for i := n - 1; i >= n - nb; i-- {
			...
			if i > 0 {
				...
				if i < n - 1 {
					blas.dgemv(.trans, i, n - i - 1, 1, w[iw + 1..], ldw, a[i..], lda, 0, mut w[
						(i + 1) * ldw + iw..], ldw)
					blas.dgemv(.no_trans, i, n - i - 1, -1, a[i + 1..], lda,
						w[(i + 1) * ldw + iw..], ldw, 1, mut w[iw..], ldw)
					blas.dgemv(.trans, i, n - i - 1, 1, a[i + 1..], lda, a[i..], lda, 0, mut w[
						(i + 1) * ldw + iw..], ldw)
					blas.dgemv(.no_trans, i, n - i - 1, -1, w[iw + 1..], ldw,
						w[(i + 1) * ldw + iw..], ldw, 1, mut w[iw..], ldw)
				}
		...
		for i := 0; i < nb; i++ {
			// Update A(i:n, i)
			blas.dgemv(.no_trans, n - i, i, -1, a[i * lda..], lda, w[i * ldw..], 1, 1, mut a[
				i * lda + i..], lda)
			blas.dgemv(.no_trans, n - i, i, -1, w[i * ldw..], ldw, a[i * lda..], 1, 1, mut a[
				i * lda + i..], lda)
			if i < n - 1 {
				// Generate elementary reflector H_i to annihilate A(i+2:n,i).
				e[i], tau[i] = dlarfg(n - i - 1, a[(i + 1) * lda + i], mut a[math.min(i + 2, n -
					1) * lda + i..], lda)
				a[(i + 1) * lda + i] = 1
				...
				blas.dgemv(.trans, n - i - 1, i, 1, w[(i + 1) * ldw..], ldw,
					a[(i + 1) * lda + i..], lda, 0, mut w[i..], ldw)
				blas.dgemv(.no_trans, n - i - 1, i, -1, a[(i + 1) * lda..], lda, w[i..], ldw, 1, mut w[
					(i + 1) * ldw + i..], ldw)
				blas.dgemv(.trans, n - i - 1, i, 1, a[(i + 1) * lda..], lda,
					a[(i + 1) * lda + i..], lda, 0, mut w[i..], ldw)
				blas.dgemv(.no_trans, n - i - 1, i, -1, w[(i + 1) * ldw..], ldw, w[i..], ldw, 1, mut w[
					(i + 1) * ldw + i..], ldw)
				blas.dscal(n - i - 1, tau[i], mut w[(i + 1) * ldw + i..], ldw)
				alpha := -0.5 * tau[i] * blas.ddot(n - i - 1, w[(i + 1) * ldw + i..], ldw, a[
					(i + 1) * lda + i..], lda)
				blas.daxpy(n - i - 1, alpha, a[(i + 1) * lda + i..], lda, mut
					w[(i + 1) * ldw + i..], ldw)
			}
		}
	}
