...
["compute","ComputeContext holds a backend-specific device and associated state. Use new_vul","compute.html#ComputeContext","struct "],
["compute","new_vulkan_context creates a compute context from an existing vulkan.Device.","compute.html#new_vulkan_context","fn "],
["compute","relu_gpu computes dst[i] = max(0, src[i]) on GPU. ctx must be a vulkan ComputeCo","compute.html#relu_gpu","fn "],
["compute","sigmoid_gpu computes dst[i] = 1/(1+exp(-src[i])) on GPU. ctx must be a vulkan Co","compute.html#sigmoid_gpu","fn "],
["compute","relu_matrix computes relu on a flat []f64 slice via GPU (f32 internally). ctx mu","compute.html#relu_matrix","fn "],
["compute","sigmoid_matrix computes sigmoid on a flat []f64 slice via GPU (f32 internally). ","compute.html#sigmoid_matrix","fn "],
["compute","gemv_gpu computes y = A * x (row-major) on GPU, with f64 data via f32 Vulkan ops","compute.html#gemv_gpu","fn "],
["compute","gemm_gpu computes C = A * B on GPU using Vulkan compute. ctx must be a vulkan Co","compute.html#gemm_gpu","fn "],
