...
["# Constants","consts.html"],
["# 🚀 Numerical Differentiation","deriv.html"],
["# 🧮 Numerical Differentiation","diff.html"],
["# Probability Distributions algorithms","dist.html"],
["# Easing Functions","easings.html"],
["","errors.html"],
["","internal.dataset.html"],
["# Fast Fourier Transform","fft.html"],
["","fit.html"],
["","float.float32.html"],
["","float.float64.html"],
["","fun.html"],
["","func.html"],
["# Geometry algorithms and structures","gm.html"],
["# Graph theory structures and algorithms","graph.html"],
["# HDF5","inout.h5.html"],
["","internal.prec.html"],
["# Iterator Tools","iter.html"],
["","la.html"],
["","ml.html"],
["# Natural Language Processing Tools","ml.nlp.html"],
["# Message Passing Interface for parallel computing","mpi.html"],
["# noise","noise.html"],
["# VSL Plot","plot.html"],
["# Polynomials","poly.html"],
["","prime.html"],
["# Quaternions","quaternion.html"],
["# One Dimensional Root-Finding","roots.html"],
["","util.html"],
["# V Computing Language","vcl.html"],
["","vcl.internal.dl.html"],
["# V Linear Algebra System","vlas.html"],
["","vlas.internal.vblas.html"],
];
...
["noise","Perlin is a struct that hold the permutation set for perlin noise","noise.html#Perlin","struct "],
["noise","perlin2d is a function that return a single value of perlin noise for a given 2d","noise.html#Perlin.perlin2d","fn (Perlin)"],
["noise","perlin3d is a function that return a single value of perlin noise for a given 3d","noise.html#Perlin.perlin3d","fn (Perlin)"],
["noise","randomize is a function that shuffle the permutation set inside the Perlin struc","noise.html#Perlin.randomize","fn (Perlin)"],
["noise","new is a function that return a new Perlin struct","noise.html#Perlin.new","fn "],
...
["poly","","poly.html#eval","fn "],
["poly","","poly.html#eval_derivs","fn "],
["poly","","poly.html#solve_quadratic","fn "],
["poly","","poly.html#solve_cubic","fn "],
["poly","","poly.html#companion_matrix","fn "],
["poly","","poly.html#balance_companion_matrix","fn "],
["poly","Arithmetic operations on polynomials","poly.html#add","fn "],
["poly","","poly.html#substract","fn "],
["poly","","poly.html#multiply","fn "],
...
["vcl","from_image_2d creates new Image and copies data from Image","vcl.html#Device.from_image_2d","fn (Device)"],
["vcl","image_2d allocates an image buffer","vcl.html#Device.image_2d","fn (Device)"],
...
["vcl","","vcl.html#Image.data_2d","fn (Image)"],
...
["vlas.internal.vblas","","vlas.internal.vblas.html#MemoryLayout","enum "],
["vlas.internal.vblas","","vlas.internal.vblas.html#Transpose","enum "],
["vlas.internal.vblas","","vlas.internal.vblas.html#Uplo","enum "],
["vlas.internal.vblas","","vlas.internal.vblas.html#Diagonal","enum "],
["vlas.internal.vblas","","vlas.internal.vblas.html#Side","enum "],
["vlas.internal.vblas","dgemm performs one of the matrix-matrix operations C = alpha * A * B + beta * C ","vlas.internal.vblas.html#dgemm","fn "],
["vlas.internal.vblas","dgemv computes y = alpha * A * x + beta * y   if trans_a = .no_trans y = alpha *","vlas.internal.vblas.html#dgemv","fn "],
["vlas.internal.vblas","dnrm2 computes the Euclidean norm of a vector, sqrt(\sum_i x[i] * x[i]). This fu","vlas.internal.vblas.html#dnrm2","fn "],
["vlas.internal.vblas","dasum computes the sum of the absolute values of the elements of x. \sum_i |x[i]","vlas.internal.vblas.html#dasum","fn "],
["vlas.internal.vblas","idamax returns the index of an element of x with the largest absolute value. If ","vlas.internal.vblas.html#idamax","fn "],
["vlas.internal.vblas","dswap exchanges the elements of two vectors. x[i], y[i] = y[i], x[i] for all i","vlas.internal.vblas.html#dswap","fn "],
["vlas.internal.vblas","dcopy copies the elements of x into the elements of y. y[i] = x[i] for all i","vlas.internal.vblas.html#dcopy","fn "],
["vlas.internal.vblas","daxpy adds alpha times x to y y[i] += alpha * x[i] for all i","vlas.internal.vblas.html#daxpy","fn "],
["vlas.internal.vblas","drotg computes the plane rotation","vlas.internal.vblas.html#drotg","fn "],
["vlas.internal.vblas","drot applies a plane transformation. x[i] = c * x[i] + s * y[i] y[i] = c * y[i] ","vlas.internal.vblas.html#drot","fn "],
["vlas.internal.vblas","dscal scales x by alpha. x[i] *= alpha dscal has no effect if incx < 0.","vlas.internal.vblas.html#dscal","fn "],
["vlas.internal.vblas","ddot computes the dot product of the two vectors \sum_i x[i]*y[i]","vlas.internal.vblas.html#ddot","fn "],
["vlas.internal.vblas","dger performs the rank-one operation A += alpha * x * yᵀ where A is an m×n de","vlas.internal.vblas.html#dger","fn "],
["vlas.internal.vblas","dgbmv performs one of the matrix-vector operations y = alpha * A * x + beta * y ","vlas.internal.vblas.html#dgbmv","fn "],
["vlas.internal.vblas","dtrmv performs one of the matrix-vector operations x = A * x   if trans_a == .no","vlas.internal.vblas.html#dtrmv","fn "],
["vlas.internal.vblas","dtrsv solves one of the systems of equations A * x = b   if trans_a == .no_trans","vlas.internal.vblas.html#dtrsv","fn "],
["vlas.internal.vblas","dsymv performs the matrix-vector operation y = alpha * A * x + beta * y where A ","vlas.internal.vblas.html#dsymv","fn "],
["vlas.internal.vblas","dtbmv performs one of the matrix-vector operations x = A * x   if trans_a == .no","vlas.internal.vblas.html#dtbmv","fn "],
["vlas.internal.vblas","dtpmv performs one of the matrix-vector operations x = A * x   if trans_a == .no","vlas.internal.vblas.html#dtpmv","fn "],
["vlas.internal.vblas","dtbsv solves one of the systems of equations A * x = b   if trans_a == .no_trans","vlas.internal.vblas.html#dtbsv","fn "],
["vlas.internal.vblas","dsbmv performs the matrix-vector operation y = alpha * A * x + beta * y where A ","vlas.internal.vblas.html#dsbmv","fn "],
["vlas.internal.vblas","dsyr performs the symmetric rank-one update A += alpha * x * xᵀ where A is an ","vlas.internal.vblas.html#dsyr","fn "],
["vlas.internal.vblas","dsyr2 performs the symmetric rank-two update A += alpha * x * yᵀ + alpha * y *","vlas.internal.vblas.html#dsyr2","fn "],
["vlas.internal.vblas","dtpsv solves one of the systems of equations A * x = b   if trans_a == .no_trans","vlas.internal.vblas.html#dtpsv","fn "],
["vlas.internal.vblas","dspmv performs the matrix-vector operation y = alpha * A * x + beta * y where A ","vlas.internal.vblas.html#dspmv","fn "],
["vlas.internal.vblas","dspr performs the symmetric rank-one operation A += alpha * x * xᵀ where A is ","vlas.internal.vblas.html#dspr","fn "],
["vlas.internal.vblas","dspr2 performs the symmetric rank-2 update A += alpha * x * yᵀ + alpha * y * x","vlas.internal.vblas.html#dspr2","fn "],
["vlas.internal.vblas","dsyrk performs one of the symmetric rank-k operations C = alpha * A * Aᵀ + bet","vlas.internal.vblas.html#dsyrk","fn "],
];
