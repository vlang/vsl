...
["compute","relu_gpu computes ReLU in-place on GPU: dst[i] = max(0, src[i]) src and dst are ","compute.html#relu_gpu","fn "],
["compute","sigmoid_gpu computes sigmoid in-place on GPU: dst[i] = 1/(1+exp(-src[i])) src an","compute.html#sigmoid_gpu","fn "],
["compute","relu_matrix computes ReLU on a flat f64 array using GPU. Returns a new []f64 wit","compute.html#relu_matrix","fn "],
["compute","sigmoid_matrix computes sigmoid on a flat f64 array using GPU. Returns a new []f","compute.html#sigmoid_matrix","fn "],
["compute","gemm_gpu computes C = A * B on GPU using Vulkan compute. All matrices are f64, r","compute.html#gemm_gpu","fn "],
...
["la","gemm_vulkan computes C = A * B using Vulkan GPU compute. All matrices are f64, r","la.html#gemm_vulkan","fn "],
