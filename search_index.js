...
["compute","relu_gpu computes dst[i] = max(0, src[i]) on GPU. This API is kept for compatibi","compute.html#relu_gpu","fn "],
["compute","sigmoid_gpu computes dst[i] = 1/(1+exp(-src[i])) on GPU. This API is kept for co","compute.html#sigmoid_gpu","fn "],
...
["la","gemm_vulkan computes C = A * B on GPU using Vulkan. dev must be an initialised v","la.html#gemm_vulkan","fn "],
