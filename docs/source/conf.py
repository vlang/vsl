...
project = u'VSL'
copyright = u'2019 Ulises Jeremias Cornejo Fandos'
author = u'Ulises Jeremias Cornejo Fandos'
title = u'VSL'
...
texinfo_documents = [
    (master_doc, 'vsl-ref', title,
     author, 'VSL', 'One line description of project.',
     'Miscellaneous'),
]
