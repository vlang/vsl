...
> NOTE: if you want better performance with Loading dynamically, you can use the `-d globalcl` flag, it will require to compile your program with the `-enable-globals` flag.
