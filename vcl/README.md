...
> NOTE: if you want better performance with Loading dynamically, you can use two `-d dlopencl -d globalcl` flags, 
> it will require to compile your program with the `-enable-globals` flag.
